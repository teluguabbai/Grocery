...
SECRET_KEY = '!5i(rc1dg2bctz*hs5ru9zhvf--@hmjd@q1%)juorvnek0$@in'
...
# Redirect Django's default login path to your custom one
LOGIN_URL = '/login/'
...
# Add this to `urlpatterns` in your `urls.py`
